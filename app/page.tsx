        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <Card className="bg-gradient-to-br from-gray-900/50 to-black/50 border-[#FCD34D]/20 backdrop-blur-sm hover:border-[#FCD34D]/40 transition-all duration-500 h-full hover:shadow-2xl hover:shadow-[#FCD34D]/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                whileHover={{ scale: 1.05 }}
              >
                <Card className="bg-gradient-to-br from-gray-900/50 to-black/50 border-[#FCD34D]/20 backdrop-blur-sm h-full">
                  <CardContent className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                <Card
                  className={`bg-gradient-to-br from-gray-900/50 to-black/50 border-[#FCD34D]/20 backdrop-blur-sm h-full transition-all duration-500 ${
                    plan.popular
                      ? "border-[#FCD34D]/50 shadow-2xl shadow-[#FCD34D]/20 scale-105"
                      : "hover:border-[#FCD34D]/40 hover:shadow-xl hover:shadow-[#FCD34D]/10"
                  }`}
                >
                  <CardContent className="p-8">
